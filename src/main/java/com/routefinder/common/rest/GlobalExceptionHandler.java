package com.routefinder.common.rest;

import com.routefinder.common.exception.*;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(MandatoryFieldIsEmptyException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public final ResponseEntity<ErrorResponse> handleMandatoryFieldIsEmptyException(
            MandatoryFieldIsEmptyException exception
    ) {
        return ResponseEntity
                .status(HttpStatus.BAD_REQUEST)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    public final ResponseEntity<ErrorResponse> handleMethodArgumentTypeMismatchException(
        ...
        String message = String.format("Invalid value for parameter '%s': must be a valid number", parameterName);
        return ResponseEntity
                .status(HttpStatus.BAD_REQUEST)
                .contentType(MediaType.APPLICATION_JSON)
